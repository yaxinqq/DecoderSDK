...
Nv12Render_D3d11va::Nv12Render_D3d11va()
	: VideoRender(), d3d11Device_(d3d11_utils::getD3D11Device()), wglD3DDevice_(d3d11_utils::getWglDeviceRef())
{
	if (d3d11Device_) {
...
bool Nv12Render_D3d11va::processNV12ToRGB(const decoder_sdk::Frame &frame)
{
	...
	if (1) {
		...
		inputViewDesc.Texture2D.ArraySlice = static_cast<UINT>(reinterpret_cast<intptr_t>(frame.data(1)));
