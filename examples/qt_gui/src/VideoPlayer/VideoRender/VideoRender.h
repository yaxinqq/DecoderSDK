...
public:
     ...
     */
    virtual void initialize(const decoder_sdk::Frame &frame, const bool horizontal = false,
                            const bool vertical = false) = 0;
     ...
     */
    virtual QOpenGLFramebufferObject *getFrameBuffer(const QSize &size)
    {
        return nullptr;
    };
};
