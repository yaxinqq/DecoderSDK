...
{
    return QStringLiteral("VAAPI Interop To OpenGL Render");
}
...
bool Nv12Render_Vaapi::interopToOpenGL(const decoder_sdk::Frame &frame)
{
...
bool Nv12Render_Vaapi::renderToFbo(const decoder_sdk::Frame &frame)
{
    Q_UNUSED(frame);
