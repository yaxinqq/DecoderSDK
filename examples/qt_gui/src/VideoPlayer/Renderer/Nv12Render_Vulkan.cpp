...
bool Nv12Render_Vulkan::interopToOpenGL(const decoder_sdk::Frame &frame)
{
...
bool Nv12Render_Vulkan::renderToFbo(const decoder_sdk::Frame &frame)
{
...
bool Nv12Render_Vulkan::convertNV12ToRGBA(const decoder_sdk::Frame &frame)
{
    ...
    struct Guard {
        ...
        Guard(const decoder_sdk::Frame &f)
            : f(f)
        {
