...
// SDK版本信息
#define DECODER_SDK_VERSION_MAJOR 1
#define DECODER_SDK_VERSION_MINOR 0
#define DECODER_SDK_VERSION_PATCH 0
#define DECODER_SDK_VERSION_BUILD 0

// 版本字符串
#define DECODER_SDK_VERSION_STRING "1.0.0"
#define DECODER_SDK_VERSION_STRING_FULL "1.0.0.0"
